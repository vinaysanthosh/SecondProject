			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<h3>Chandhan Sai</h3>
						<p>I came to NIIT with the hope of gathering knowledge from
		...
		<div class="section">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h1 class="text-primary">Student Speak</h1>
						<h3>Tarun and Manoj</h3>
						<p>I would like to thank NIIT for helping me to get a job. The
							team of NIIT supported a lot. Even though I am from BSc, the
							faculty helped me to develop my IT skills from the basics to a
							standard level. The grooming sessions which were provided to me
							by the NIIT training team really helped me to develop the
							character, personality and confidence which was needed to get a
							good job. I'm really thankful to all the staff and all my faculty
							members who has taught me and helped me. I feel very proud to be
							associated with such a good brand called "NIIT". I would to share
							my experience to crack any interview of your choic.. The first
							impression should be a very confident one. No matter how nervous
							you are from inside but make sure that you are confident from
							outside. Think before going to any interview that "the
							organization needs you more that you need an organization". Be
							confident... All the best..</p>
					</div>
					<div class="col-md-6">
			...
			<div class="col-md-12 col-xs-12">
				<div class="well">
					...
					<span lang=EN-US
						...
						<p class=MsoNormal style="margin: 0in 0in 0pt">
							<span><strong>NIIT Vijayawada Office</strong>:<br>NIIT Ltd,<br>
								Lohia Towers, Third floor,<br>Vijayawada, AndhraPradesh - 520012,<br>India<br>Tel:
								0866-6556551</span><span style="font-size: 12pt"></span>
						</p>
						<p class=MsoNormal style="margin: 0in 0in 0pt">
							<span style="font-size: 12pt"> www.niitvijayawada.com/</span>
						</p>
					</span>
